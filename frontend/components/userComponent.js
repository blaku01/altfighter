...
function UserComponent() {
    ...
    return (
        <div className="w-[45vw] h-[90vh] my-[5vh] flex items-center justify-center " style={{ zIndex: 1 }}>
            {/* user info */}
            <div className="self-center flex flex-col w-[90%] h-[100%] items-center justify-center">
                ...
                <div className="w-[100%] h-[40%] flex flex-wrap items-center justify-center">
